...
"}")
        ...
        self.botonVerificar.setGeometry(QtCore.QRect(550, 640, 141, 41))
...
"}")
        ...
        self.labelTutorial.setGeometry(QtCore.QRect(80, 10, 361, 31))
...
"color: rgb(156, 100, 12);")
        ...
        self.lblCamara.setGeometry(QtCore.QRect(390, 330, 431, 291))
...
"border-bottom: 3px solid  rgb(0, 85, 0);")
        ...
        self.label = QtWidgets.QLabel(IG5_Sena)
        self.label.setGeometry(QtCore.QRect(390, 330, 431, 291))
        self.label.setStyleSheet("background-color: rgb(170, 170, 255,0.4);\n"
"color: rgb(156, 100, 12);\n"
...
"}")
    ...
    def retranslateUi(self, IG5_Sena):
        ...
        self.label.setText(_translate("IG5_Sena", "3"))
