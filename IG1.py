...
"")
        ...
        self.gridLayout_3.setContentsMargins(50, -1, 50, 9)
...
"}")
    ...
    def retranslateUi(self, IG1_Bienvenida):
        ...
        self.botonUsuario2.setText(_translate("IG1_Bienvenida",self.nombreUsuario(2)))
        self.botonUsuario4.setText(_translate("IG1_Bienvenida",self.nombreUsuario(4)))


    def eventos(self,IG1_Bienvenida):
        self.botonUsuario1.clicked.connect(lambda:self.abrirIG2(IG1_Bienvenida,1))
        self.botonUsuario2.clicked.connect(lambda:self.abrirIG2(IG1_Bienvenida,2))
        self.botonUsuario3.clicked.connect(lambda:self.abrirIG2(IG1_Bienvenida,3))
        self.botonUsuario4.clicked.connect(lambda:self.abrirIG2(IG1_Bienvenida,4))

    def abrirIG2(self,IG1_Bienvenida, id_usuario):
        IG1_Bienvenida.hide()
        self.IIG2=QtWidgets.QWidget()
        ui = G2.Ui_IG2_MenuUsuario()
        ui.setIDUsuario(id_usuario)
